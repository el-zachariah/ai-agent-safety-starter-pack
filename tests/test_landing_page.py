...
class LiveDistributionProofTests(unittest.TestCase):
    def test_live_distribution_proof_is_linked_and_specific(self):
        ...
        self.assertIn("2026-07-07T19:37:02-05:00", proof)
        ...
        self.assertIn("stricter plugin marketplace route moved from unknown mergeability to `OPEN` + `MERGEABLE`", proof)
        self.assertIn("head `558a59e`", proof)
