...
class LiveDistributionProofTests(unittest.TestCase):
    def test_live_distribution_proof_is_linked_and_specific(self):
        ...
        self.assertIn("LIVE_DISTRIBUTION_PROOF_REFRESH_2026_07_07_SENTINEL_1053", index)
        self.assertIn("LIVE_DISTRIBUTION_PROOF_REFRESH_2026_07_07_SENTINEL_1053", proof)
