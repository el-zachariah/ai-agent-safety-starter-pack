...
**Live public distribution proof:** [`docs/live-distribution-proof.md`](docs/live-distribution-proof.md) gives a 60-second verification path through the free source repo, the merged Build with Claude route, CLA-green marketplace routes, the sentinel-changed harness-engineering route rechecked clean after a transient unknown state, the jqueryscript route, the strict plugin route re-read as mergeable at head `7a4239ff0e30` after the current-main rebase, the parked non-fit route, and the Yellow/Red buy trigger before checkout. Fresh readback markers: `LIVE_DISTRIBUTION_PROOF_REFRESH_2026_07_07_SENTINEL_1759` `STRICT_PLUGIN_ROUTE_MERGEABLE_READBACK_2026_07_07_1937` `STRICT_PLUGIN_ROUTE_GREEN_RECHECK_2026_07_08_0142` `LIVE_DISTRIBUTION_TRUST_REFRESH_2026_07_08_0412` `HARNESS_ROUTE_CLEAN_RECHECK_2026_07_08_0735`
