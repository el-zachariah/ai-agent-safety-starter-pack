...
**Live public distribution proof:** [`docs/live-distribution-proof.md`](docs/live-distribution-proof.md) gives a 60-second verification path through the free source repo, the merged Build with Claude route, CLA-green marketplace routes, the sentinel-changed harness-engineering and jqueryscript routes, the strict plugin route now mergeable after a review-fix push, the parked non-fit route, and the Yellow/Red buy trigger before checkout. Fresh readback markers: `LIVE_DISTRIBUTION_PROOF_REFRESH_2026_07_07_SENTINEL_1759` `STRICT_PLUGIN_ROUTE_MERGEABLE_READBACK_2026_07_07_1937`
