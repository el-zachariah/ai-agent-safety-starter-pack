...
Use this page if the Payhip page, download step, or pre-purchase decision gets confusing and you want help without exposing private repository or billing details.
...
3. If the page is unavailable, confusing, or does not match the public description, open the public-safe buyer support form: <https://github.com/el-zachariah/ai-agent-safety-starter-pack/issues/new?template=buyer-question.yml>.
...
Where I got stuck: product page / checkout wording / download / ZIP verifier / install step.
