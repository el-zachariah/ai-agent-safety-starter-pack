...
| <https://github.com/jeremylongshore/claude-code-plugins-plus-skills/pull/964> | OPEN, mergeable, REVIEW_REQUIRED, prescreen-grade success, review-fix readback posted | A stricter marketplace route has source package review history, public fixes, and a successful prescreen. |
