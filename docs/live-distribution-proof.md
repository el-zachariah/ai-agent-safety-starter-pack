...
| <https://github.com/jeremylongshore/claude-code-plugins-plus-skills/pull/964> | OPEN, mergeable, REVIEW_REQUIRED, public checks include `prescreen` and `Greptile Review` | A stricter marketplace route has source package review history, public fixes, successful automated review signals, and a successful prescreen. |
